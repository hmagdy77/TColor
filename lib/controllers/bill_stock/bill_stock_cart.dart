...
abstract class BillStockCartController extends GetxController {
  addToCarts({required Item item});
  addAllToCarts({required List<Item> items});
...
class BillStockCartControllerImp extends BillStockCartController {
  Map myCarts = {}.obs;
