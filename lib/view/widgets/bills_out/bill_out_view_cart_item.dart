...
class BillOutViewCartItem extends StatelessWidget {
  const BillOutViewCartItem({
    Key? key,
    required this.item,
  }) : super(key: key);
  final Item item;
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            '${AppStrings.itemQuantity} : ${item.itemCount}',
          ...
          Text(
            '${AppStrings.total} : ${double.parse(item.itemPriceOut) * double.parse(item.itemCount)}',
            style: context.textTheme.displaySmall,
            textAlign: TextAlign.start,
          ),
        ],
