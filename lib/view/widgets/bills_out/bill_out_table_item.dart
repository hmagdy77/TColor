...
class BillOutTableItem extends StatelessWidget {
  BillOutTableItem({
    super.key,
    this.item,
    required this.isHeader,
    required this.isInDayReport,
  });
  final Item? item;
  final bool isHeader;
  final bool isInDayReport;
      ...
      return Row(
        children: [
          ...
          MyCiel(
            ...
            width: 2,
            text:
                (double.parse(item!.itemPriceOut) * double.parse(item!.itemMin))
                    .toStringAsFixed(2),
          ),
          MyCiel(
            isBack: false,
          ...
          MyCiel(
            ...
            width: 2,
            text:
                (double.parse(item!.itemPriceOut) * double.parse(item!.itemMax))
                    .toStringAsFixed(2),
          ),
          isInDayReport
              ? const SizedBox()
