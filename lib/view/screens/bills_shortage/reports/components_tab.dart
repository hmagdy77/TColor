...
class ComponentsTab extends StatelessWidget {
          ...
          if (billOutReportController.isLoading.value ||
            ...
            return Column(
              children: [
                    ...
                    Row(
                      children: [
                        IconButton(
                          ...
                          onPressed: () {
                            billOutReportController.clearComCart();
                    ...
                    MyButton(
                      ...
                      onPressed: () {
                        ...
                        if (billOutReportController
                            ...
                            billOutReportController.componentsSearch.isEmpty) {
                          items = billOutReportController
                              .componentsUniqeCarts.values
                              .toList();
                        } else {
                          items = billOutReportController.componentsSearch;
                        }
                        ...
                        printBill(
                          ...
                          label:
                              '${AppStrings.billOutReports} ${AppStrings.components}',
                          kind: '2',
                          total: '0',
                ...
                MyTextField(
                  hidePassword: false,
                  controller: billOutReportController.searchComTextField,
                  validate: (val) {},
                  label: AppStrings.search,
                  onChanged: (val) {
                    billOutReportController.search(searchName: val, kind: 1);
                  },
                  onSubmite: (val) {},
                ),
                //for height
                  ...
                  child: Obx(
                    () {
                      if (billOutReportController.isLoading.value) {
                        ...
                        if (billOutReportController.componentsSearch.isEmpty &&
                          ...
                          return ListView.builder(
                            itemCount:
                                billOutReportController.componentsSearch.length,
                            itemBuilder: (context, index) {
                              List items =
                                  billOutReportController.componentsSearch;
                              return BillOutTableItem(
                                isHeader: false,
                                item: items[index],
                                isInDayReport: false,
  ...
  void getItems() async {
    if (billOutReportController.startDate.isEmpty) {
      ...
      await billOutReportController.addListToComCart(
        items: itemController.componetsItemsList,
      );
      await billOutReportController.updateComItems(
