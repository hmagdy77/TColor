...
import '../../widgets/bills_shortage/bill_minus_shortage_cart_item.dart';
...
class AddMinusBillShortageScreen extends StatelessWidget {
  AddMinusBillShortageScreen({super.key});
  ...
  Future<void> printFunc({required Bill bill}) async {
    ...
    printBill(
      ...
      label: '${AppStrings.bill} ${AppStrings.billShortageMinus}',
      total:
      ...
      () {
        if (cartController.myCarts.isEmpty) {
          ...
          return GridView.builder(
            ...
            itemBuilder: (context, index) {
              return BillMinusShortageCartItem(
                index: index,
