...
import '../../widgets/bills_in/bill_in_back_cart_item.dart';
...
class AddBackBillInScreen extends StatelessWidget {
  AddBackBillInScreen({super.key});
        ...
        return Column(
          children: [
            Row(
              ...
              children: [
                Text(
                  ' ${AppStrings.billInBackNumper} : ${bill.billId.toString()}',
                  style: context.textTheme.displayLarge,
                ),
                Text(
                ...
                Text(
                  '${AppStrings.billDate} : ${billInController.billDate.value}',
                  //${DateFormat.yMEd().format(DateTime.now())}',
                  style: context.textTheme.displayLarge,
                ),
                // MyButton(
                //   text: AppStrings.billDate,
                //   onPressed: () {
