...
class SubStockTab extends StatelessWidget {
  SubStockTab({super.key});
          ...
          if (billFactoryItemController.isLoading.value ||
            ...
            return Column(
              children: [
                    ...
                    Row(
                      children: [
                        IconButton(
                          ...
                          onPressed: () {
                            stockReportController.clearSubComCart();
                    ...
                    MyButton(
                      ...
                      onPressed: () {
                        ...
                        if (stockReportController
                                .searchSubComTextField.text.isEmpty &&
                            stockReportController.subComponentsSearch.isEmpty) {
                          items = stockReportController
                              .subComponentsUniqeCarts.values
                              .toList();
                        } else {
                          items = stockReportController.subComponentsSearch;
                        }
                ...
                MyTextField(
                  hidePassword: false,
                  controller: stockReportController.searchSubComTextField,
                  validate: (val) {},
                  label: AppStrings.search,
                  onChanged: (val) {
                    stockReportController.search(searchName: val, kind: 3);
                  },
                  onSubmite: (val) {},
                ),
                //for height
                  ...
                  child: Obx(
                    () {
                      if (stockReportController.isLoading.value) {
                        ...
                        if (stockReportController.subComponentsSearch.isEmpty &&
                            stockReportController
                                .searchSubComTextField.text.isNotEmpty) {
                          return const MyLottieEmpty();
                        } else if (stockReportController
                                .subComponentsSearch.isEmpty &&
                            stockReportController
                                .searchSubComTextField.text.isEmpty) {
                          return ListView.builder(
                            ...
                            itemCount: stockReportController
                                .subComponentsUniqeCarts.length,
                          );
                        } else {
                          return ListView.builder(
                            itemCount: stockReportController
                                .subComponentsSearch.length,
                            itemBuilder: (context, index) {
                              List items =
                                  stockReportController.subComponentsSearch;
                              return ReporTableItem(
                                isHeader: false,
                                kind: AppStrings.subStock,
                                item: items[index],
  ...
  void getItems() async {
    if (stockReportController.startDate.isEmpty) {
      ...
      await stockReportController.addListToSubComCart(
        items: itemController.componetsItemsList,
      );
      await stockReportController.updateSubComItems(
