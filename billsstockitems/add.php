...
$stmt = $con->prepare("INSERT INTO `billstockitems`(`item_name`, `item_num`, `item_sup`, `item_price_in`, `item_price_out`, `item_count`, `bill_id`,`stock_id`, `kind`, `item_time`)  VALUES (?,?,?,?,?,?,?,?,?,?)");
